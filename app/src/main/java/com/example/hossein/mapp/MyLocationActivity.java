...
//******************************************************************
    ...
    //    new AsyncTasktimrt("http://hpph12.cloudsite.ir/dgkala/golryy.php").execute();
        Toast.makeText(MyLocationActivity.this,mhyani.tst+"12", Toast.LENGTH_LONG).show();//"http://hpph12.cloudsite.ir/dgkala/golryy.php"
      ...
      Button  ser = (Button) findViewById(R.id.serch_b);
        ...
        ser.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               new AsyncTasktimrt("http://mivefarangi.companynegin.com/latt.php").execute();

if(mhyani.tst.equals(""))
{
    Toast.makeText(MyLocationActivity.this,mhyani.tst+"12", Toast.LENGTH_LONG).show();
...
//    Intent intent=new Intent(MyLocationActivity.this,mhyani.class);
...
//                try {
//                    JSONArray jsonArray = new JSONArray(Splashh.data);
//                    for (int i = 0; i < jsonArray.length(); i++) {
//
//                        JSONObject object = jsonArray.getJSONObject(i);
//                         lat = object.getInt(String.valueOf("lat"));
//                         lon =  object.getInt(String.valueOf("lon"));
//                     //   LatLng ttt = new LatLng(lat,lon);
//                        Toast.makeText(MyLocationActivity.this, lat+"fg" , Toast.LENGTH_LONG).show();
//
...
//                }
        ...
        m_sabtr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(MyLocationActivity.this,MapsActivity_Serch.class);
                startActivity(intent);
    }
});
